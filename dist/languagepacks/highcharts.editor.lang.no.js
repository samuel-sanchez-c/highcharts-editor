/*
    ...
    no Language Pack for the Highcharts Editor

    This file was generated by tools/gen.localization.js from
    no.json, Tue Oct 08 2019 16:36:58 GMT-0400 (Eastern Daylight Time)
...
highed.installLanguage({
    language: "no", 
    entries: {
      "confirmNewChart": "Vil du virkelig lage et nytt diagram? Alle endringer vil bli mistet.",
      "previewChart": "Forhåndsvis",
      "newChart": "Ny",
      "saveProject": "Lagre Prosjekt",
      "loadProject": "Åpne Prosjekt",
      "exportPNG": "Eksporter som PNG",
      "exportJPEG": "Eksporter som JPEG",
      ...
      "stepImport": "Importer",
      "stepTemplates": "Maler",
      "stepCustomize": "Juster",
      "stepExport": "Eksporter",
      "stepData": "Data",
      "doneCaption": "Lukk & Generer Diagram",
      "dgDeleteRow": "Vil du virkelig slette valgte rader?",
      "dgWithSelected": "Med valgte rader:",
      "dgImportBtn": "IMPORTER",
      "dgExportBtn": "EKPORTER",
      "dgNewBtn": "NY",
      "dgAddRow": "LEGG TIL RAD",
      "dgDataImported": "Data importert",
      "dgDataImporting": "Importerer data",
      "dgNewCol": "Ny kolonne",
      "dgSortAsc": "Sorter Stigende",
      "dgSortDec": "Sorter Synkende",
      "dgSortAscMonth": "Sorter som månednavn, stigende",
      "dgSortDecMonth": "Sorter som månednavn, synkende",
      "dgDelCol": "Slett kolonne",
      "dgDelColConfirm": "Vil du virkelig slette kolonnen?",
      "dgInsColBefore": "Sett inn kolonne før",
      "dgInsColAfter": "Sett inn kolonne etter",
      "customizeSimple": "ENKEL",
      "customizeAdvanced": "AVANSERT",
      "option.cat.title": "Tittler",
      "option.subcat.titles": "Hovedtittler",
      "option.cat.general": "Generelt",
      "option.subcat.size": "Størrelse",
      "option.subcat.interaction": "Interaktivitet",
      "option.cat.appearance": "Utseende",
      "option.subcat.fonts": "Fonter",
      "option.subcat.titlestyle": "Tittelstil",
      "option.subcat.seriescolors": "Seriefarger",
      "option.subcat.chartarea": "Chart Area",
      "option.subcat.plotarea": "Plot Area",
      "option.cat.axes": "Akser",
      "option.subcat.axessetup": "Akseinstillinger",
      "option.subcat.xaxis": "X-Akse",
      "option.subcat.yaxis": "Y-Akse",
      "option.cat.series": "Dataserier",
      "option.cat.labels": "Dataetikketter",
      "option.subcat.labels": "Dataetikketter",
      "option.cat.legend": "Legende",
      "option.subcat.general": "Generelt",
      "option.subcat.placement": "Posisjonering",
      "option.subcat.legendappearance": "Utseende",
      "option.cat.tooltip": "Verktøytips",
      "option.subcat.colorborder": "Farge og Kant",
      "option.cat.exporting": "Eksportering",
      "option.cat.localization": "Lokalisering",
      "option.subcat.numberformat": "Nummerformat",
      "option.subcat.exportbutton": "Eksporteringsknapp",
      "option.subcat.zoombutton": "Forstørrelsesknapp",
      "option.cat.credits": "Kreditering",
      "option.text.title.text": "Hovedtittel",
      "option.tooltip.title.text": "The main chart title.",
      "option.text.subtitle.text": "Undertittel",
      "option.tooltip.subtitle.text": "The chart's subtitle, normally displayed with smaller fonts below the main title.",
      "option.text.yAxis.title.text": "Tittel for y-akse",
      "option.tooltip.yAxis.title.text": "The Y axis title, normally displayed vertically along the Y axis.",
      "option.text.chart.width": "Lengde",
      ...
      "option.text.chart.height": "Høyde",
      ...
      "option.text.chart.zoomType": "Tillat forstørring",
      ...
      "option.text.chart.polar": "Polar (radar) projeksjon",
      ...
      "option.text.xAxis.title.style": "X-akse tittel",
      "option.tooltip.xAxis.title.style": "Styling and text for the X axis title",
      "option.text.xAxis.title.text": "Tekst",
      ...
      "option.tooltip.xAxis.type": "Aksetype",
      "option.text.xAxis.opposite": "Tegn akse på motsatt side",
      ...
      "option.text.xAxis.reversed": "Reversert rettning",
      ...
      "option.text.xAxis.labels.format": "X-Akse tittelformat",
      ...
      "option.text.yAxis.title.style": "Y-akse tittelstil",
      "option.tooltip.yAxis.title.style": "Styling and text for the X axis title",
      "option.text.yAxis.type": "Type",
      "option.tooltip.yAxis.type": "Aksetype",
      "option.text.yAxis.opposite": "Tegn akse på motsatt side",
      ...
      "option.text.yAxis.reversed": "Reversert rettning",
      ...
      "option.text.yAxis.labels.format": "Y-Akse tittelformat",
      ...
      "option.text.series.type": "Serietype",
      "option.tooltip.series.type": "The type of series",
      "option.text.series.color": "Farge",
      ...
      "option.text.series.negativeColor": "Negativ farge",
      ...
      "option.text.series.colorByPoint": "Fargelegg per. punkt",
      ...
      "option.text.series.marker.enabled": "Aktiver punkt markør",
      ...
      "option.text.series.marker.symbol": "Markørsymbol",
      ...
      "option.text.plotOptions.series.dataLabels.enabled": "Aktiver dataetikketter for alle punkt",
      ...
      "option.text.plotOptions.series.dataLabels.style": "Tekststil",
      "option.tooltip.plotOptions.series.dataLabels.style": "Styles for the label.",
      "option.text.legend.enabled": "Aktiver legende",
